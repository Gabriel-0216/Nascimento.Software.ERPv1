...
namespace Infra.Migrations
{
    ...
    [Migration("20211203125124_scriptInicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Buyer.Buyers", b =>
                {
                    ...
                    b.OwnsOne("Domain.Value_Objects.Name", "Name", b1 =>
                        {
                            b1.Property<string>("BuyersId")
                                .HasColumnType("nvarchar(450)");
                    ...
                    b.OwnsMany("Domain.Value_Objects.Email", "Emails", b1 =>
                        {
                            b1.Property<string>("BuyersId")
                                .HasColumnType("nvarchar(450)");
                    ...
                    b.OwnsMany("Domain.Value_Objects.PhoneNumber", "Phone", b1 =>
                        {
                            b1.Property<string>("BuyersId")
                                .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entities.Product.Products", b =>
                {
                    b.OwnsOne("Domain.Value_Objects.Name", "ProductName", b1 =>
                        {
            ...
            modelBuilder.Entity("Domain.Entities.Payments.BoletoPayment", b =>
                {
                    b.OwnsOne("Domain.Value_Objects.Address", "PaymentAddress", b1 =>
                        {
